...
from DAGAN.generation_builder import ExperimentBuilder
...
data = dataset.Cifar100Dataset(batch_size=batch_size, last_training_class_index=1600, reverse_channels=True,
