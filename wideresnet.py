...
class WideResNet(nn.Module):
    def __init__(self, depth, width, num_classes=10, dropout=0.3):
        ...
        self.layer1 = self._make_layer(16*width, blocks_per_layer, dropout)
        self.layer2 = self._make_layer(32*width, blocks_per_layer, dropout, stride=2)
        self.layer3 = self._make_layer(64*width, blocks_per_layer, dropout, stride=2)
...
def wideresnet28_10(num_classes):
    return WideResNet(depth=28, width=10, num_classes=num_classes)